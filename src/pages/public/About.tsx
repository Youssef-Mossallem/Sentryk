...
export default function About() {
  ...
  // تصحيح النوع هنا ليتوافق مع TypeScript
  ...
  // تصحيح النوع هنا لحل مشكلة الـ ease والـ duration
  const fadeInUp: any = {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#030712] transition-colors duration-700 text-right overflow-x-hidden pb-20" dir="rtl">
      ...
      <section className="pt-56 pb-20 px-6 relative">
        ...
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-primary-600/5 border border-primary-600/20 text-primary-600 mb-10 font-bold text-sm tracking-widest uppercase">
             <Sparkles size={16} />
             <span>نحن من نسعى للاحترافية التعليمية</span>
          </motion.div>
          
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-6xl font-black mb-8 dark:text-white leading-[1.2] tracking-tight">
            سنتريك — نظام ذكي لإدارة السناتر
          </motion.h1>
          
          <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium">
            نحن منظومة متكاملة صممت لتسهيل إدارة المراكز التعليمية، متابعة الطلاب والاشتراكات، وضمان الشفافية المالية. هدفنا أن نمنح أصحاب السناتر السيطرة التامة على كل تفاصيل العمل دون تعقيد.
          </motion.p>
        </motion.div>
      </section>

      {/* --- Section 2: الرؤية والهدف --- */}
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.h2 variants={fadeInUp} className="text-4xl font-black dark:text-white border-r-4 border-primary-600 pr-6">رؤيتنا</motion.h2>
            <motion.p variants={fadeInUp} className="text-xl text-slate-600 dark:text-slate-400 leading-loose font-medium">
              نسعى لأن يكون سنتريك المعيار الموثوق لإدارة المراكز التعليمية في مصر، بتقديم حلول تقنية ذكية، دقيقة، وسهلة الاستخدام.
            </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
              <motion.div variants={fadeInUp} className="p-8 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none">
                ...
                <h4 className="text-xl font-black dark:text-white mb-2">قيمنا</h4>
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-bold">الشفافية، الدقة، احترام وقت المعلم، والحفاظ على ثقة أولياء الأمور.</p>
              </motion.div>
              <motion.div variants={fadeInUp} className="p-8 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none">
                <Users className="text-primary-600 mb-4" size={32} />
                <h4 className="text-xl font-black dark:text-white mb-2">من نحن</h4>
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-bold">فريق صغير من المتخصصين في الإدارة الرقمية للمراكز التعليمية، ملتزمون بتقديم حلول عملية وموثوقة لكل صاحب سنتر.</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="aspect-square bg-slate-900 dark:bg-primary-600 rounded-[3rem] p-12 flex flex-col justify-center items-center text-center shadow-3xl">
              ...
              <MousePointer2 size={60} className="text-primary-400 mb-6" />
              <h3 className="text-3xl font-black text-white mb-6 leading-tight">خبرة، موثوقية، وسيطرة كاملة على كل شيء.</h3>
      ...
      <section className="py-32 px-6 bg-white/50 dark:bg-slate-900/10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black dark:text-white mb-6">لماذا سنتريك؟</h2>
            <p className="text-slate-500 dark:text-slate-400 font-bold italic text-xl">الحلول التي نقدمها تمنحك الثقة والراحة في إدارة سنترك.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              { 
                ...
                title: "أمان البيانات", 
                desc: "نحمي بيانات طلابك وحساباتك المالية بأعلى معايير الأمان لمنع أي اختراق أو فقدان." 
              },
              { 
                icon: <Users size={36} />, 
                title: "دعم موثوق", 
                desc: "نقدم استشارات ومتابعة دورية لتطوير إدارة مركزك وزيادة فعالية العمل." 
              },
              { 
                icon: <GraduationCap size={36} />, 
                title: "خبرة متخصصة", 
                desc: "نركز على حلول عملية سهلة التطبيق لضمان تجربة مستخدم متميزة وموثوقة." 
              }
            ].map((feature, i) => (
              <motion.div 
                key={i}
      ...
      <section className="py-40 px-6 text-center">
        ...
        >
          ...
          >
             Sentryk • ثقة المعلمين والمراكز التعليمية
          </motion.div>
        </motion.div>
      </section>
